// PARA BARRA DE DESPLAZAMIENTO PARA BARRA PERFIL DE USUARIO
    ...
    function keyboard(i) {
        ...
        function shouldPreventDefault(deltaX, deltaY) {
            ...
            if (deltaX === 0) {
                ...
                if (
                    (scrollTop === 0 && deltaY > 0) || (scrollTop >= i.contentHeight - i.containerHeight && deltaY < 0)) {
            ...
            if (deltaY === 0) {
                ...
                if (
                    (scrollLeft === 0 && deltaX < 0) || (scrollLeft >= i.contentWidth - i.containerWidth && deltaX > 0)) {
                    return !i.settings.wheelPropagation;
                }
            }
            return true;
        ...
        i.event.bind(i.ownerDocument, 'keydown', function(e) {
            if (
                (e.isDefaultPrevented && e.isDefaultPrevented()) || e.defaultPrevented) {
                return;
            }
        ...
        function shouldBeConsumedByChild(target, deltaX, deltaY) {
            ...
            while (cursor && cursor !== element) {
                ...
                if (deltaY && style.overflowY.match(/(scroll|auto)/)) {
                    ...
                    if (maxScrollTop > 0) {
                        if (
                            (cursor.scrollTop > 0 && deltaY < 0) || (cursor.scrollTop < maxScrollTop && deltaY > 0)) {
                            return true;
                        }
                    }
                }
                ...
                if (deltaX && style.overflowX.match(/(scroll|auto)/)) {
                    ...
                    if (maxScrollLeft > 0) {
                        if (
                            (cursor.scrollLeft > 0 && deltaX < 0) || (cursor.scrollLeft < maxScrollLeft && deltaX > 0)) {
                            return true;
                        }
                    }
                }
    ...
    function touch(i) {
        ...
        function shouldPrevent(deltaX, deltaY) {
            ...
            if (magnitudeY > magnitudeX) {
                ...
                if (
                    (deltaY < 0 && scrollTop === i.contentHeight - i.containerHeight) || (deltaY > 0 && scrollTop === 0)) {
                ...
                if (
                    (deltaX < 0 && scrollLeft === i.contentWidth - i.containerWidth) || (deltaX > 0 && scrollLeft === 0)) {
                    return true;
                }
            }
            return true;
...
var KTLayoutAsideMenu = function() {
    ...
    return {
        init: function(n) {
            var i, o, l, r;
            (e = KTUtil.getById(n), t = KTUtil.getBody(), e) && (o = "1" === KTUtil.attr(e, "data-menu-dropdown") ? "dropdown" : "accordion", "1" === KTUtil.attr(e, "data-menu-scroll") && (i = {
                rememberPosition: !0,
                height: function() {
                    if (!KTUtil.isBreakpointDown("lg")) {
                        var t = parseInt(KTUtil.getViewPort().height);
                        return (t -= KTLayoutBrand.getHeight()) - (parseInt(KTUtil.css(e, "marginBottom")) + parseInt(KTUtil.css(e, "marginTop")))
                    }
                }
            }), a = new KTMenu(e, {
                scroll: i,
    ...
    return {
        init: function(n) {
            e = KTUtil.getById(n), t = KTUtil.getBody(), e && ((a = new KTToggle(e, t, {
                ...
                KTUtil.addClass(t, "aside-minimizing"), KTUtil.transitionEnd(t, (function() {
                    KTUtil.removeClass(t, "aside-minimizing")
                })), KTLayoutStickyCard.update(), KTLayoutHeaderMenu.pauseDropdownHover(800), KTLayoutAsideMenu.pauseDropdownHover(800);
                var a = $(".kt-datatable");
                a && a.each((function() {
...
var KTLayoutSidebar = function() {
    var t, e, a, n, i = function(t) {
        t = KTUtil.getById(t);
        var a = KTUtil.find(e, ".sidebar-wrapper"),
            n = KTUtil.find(t, ".sidebar-header"),
            i = KTUtil.find(t, ".sidebar-content");
        $(n).on("click", ".sidebar-toggle", (function(t) {
            ...
            height: function() {
                var t = parseInt(KTUtil.getViewPort().height);
                return KTUtil.isBreakpointUp("lg") && (t -= KTLayoutHeader.getHeight()), n && (t -= parseInt(KTUtil.css(n, "height")), t -= parseInt(KTUtil.css(n, "marginTop")), t -= parseInt(KTUtil.css(n, "marginBottom"))), i && (t -= parseInt(KTUtil.css(i, "marginTop")), t -= parseInt(KTUtil.css(i, "marginBottom"))), t -= parseInt(KTUtil.css(a, "paddingTop")), t -= parseInt(KTUtil.css(a, "paddingBottom")), t -= parseInt(KTUtil.css(e, "paddingTop")), t -= parseInt(KTUtil.css(e, "paddingBottom")), t -= 2
            }
        })
    };
    return {
        init: function(o) {
            var l;
            (e = KTUtil.getById(o), t = KTUtil.getBody(), e) && (a = new KTOffcanvas(e, {
                baseClass: "sidebar",
                overlay: !0,
            ...
            }), (l = KTUtil.find(e, ".sidebar-nav")) && (KTUtil.scrollInit(l, {
                disableForMobile: !0,
                resetHeightOnDestroy: !0,
                handleWindowResize: !0,
                height: function() {
                    var t = parseInt(KTUtil.getViewPort().height),
                        a = KTUtil.find(e, ".sidebar-nav"),
                        n = KTUtil.find(e, ".sidebar-footer");
                    return t -= parseInt(KTUtil.css(a, "height")), t -= parseInt(KTUtil.css(a, "marginBottom")) + parseInt(KTUtil.css(a, "marginTop")), (t -= parseInt(KTUtil.css(n, "height"))) - (parseInt(KTUtil.css(n, "marginBottom")) + parseInt(KTUtil.css(n, "marginTop")))
                }
            }), $(l).on("click", 'a[data-toggle="tab"]', (function(t) {
                n && n.is($(this)) && $("body").hasClass("sidebar-expanded") ? KTLayoutSidebar.minimize() : (n = $(this), KTLayoutSidebar.expand())
            }))), i("kt_sidebar_tab_1"), i("kt_sidebar_tab_2"), i("kt_sidebar_tab_3"))
        },
        getElement: function() {
            return e
        },
        ...
        expand: function() {
            KTUtil.addClass(t, "sidebar-expanded")
        },
        minimize: function() {
            KTUtil.removeClass(t, "sidebar-expanded")
        }
    }
}();
"undefined" != typeof module && (module.exports = KTLayoutSidebar);
var KTLayoutStickyCard = function() {
    var t, e;
    return {
        init: function(a) {
            (t = KTUtil.getById(a)) && ((e = new KTCard(t, {
                sticky: {
                    ...
                    position: {
                        top: function() {
                            var t = 0;
                            return KTUtil.getBody(), KTUtil.isBreakpointUp("lg") ? (KTLayoutHeader.isFixed() && (t += KTLayoutHeader.getHeight()), KTLayoutSubheader.isFixed() && (t += KTLayoutSubheader.getHeight())) : KTLayoutHeader.isFixedForMobile() && (t += KTLayoutHeader.getHeightForMobile()), t
                        },
                        left: function(e) {
    ...
    var t = function(t) {
        ...
        e = function(t) {
            ...
            if (0 !== n.value.length) {
                ...
                var o, l = "";
                l += '<div class="d-flex align-items-center">', l += "\t<div>", l += '\t\t<span class="text-muted font-size-sm">2 Hours</span>', l += '\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">You</a>', l += "\t</div>", l += '\t<div class="symbol symbol-circle symbol-40 ml-3">', l += '\t\t<img alt="Pic" src="assets/media/users/150-9.jpg"/>', l += "\t</div>", l += "</div>", l += '<div class="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-400px">' + n.value + "</div>", KTUtil.setHTML(i, l), e.appendChild(i), n.value = "", a.scrollTop = parseInt(KTUtil.css(e, "height")), (o = KTUtil.data(a).get("ps")) && o.update(), setTimeout((function() {
                    var t = document.createElement("DIV");
                    KTUtil.addClass(t, "d-flex flex-column mb-5 align-items-start");
                    var i;
                    KTUtil.setHTML(t, '<div class="d-flex align-items-center">\t<div class="symbol symbol-circle symbol-40 mr-3">\t\t<img alt="Pic" src="assets/media/users/150-11.jpg"/>\t</div>\t<div>\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">Matt Pears</a>\t\t<span class="text-muted font-size-sm">Just now</span>\t</div></div><div class="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px">Right before vacation season we have the next Big Deal for you.</div>'), e.appendChild(t), n.value = "", a.scrollTop = parseInt(KTUtil.css(e, "height")), (i = KTUtil.data(a).get("ps")) && i.update()
                }), 2e3)
            }
        };
    return {
